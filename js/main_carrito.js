function ProductosCarrito() {
    ...
    for (let producto of productos) {
        ...
        <td class="align-middle">Cantidad: ${producto.cantidad}</td>
        <td class="align-middle">Precio: $${precio}</td>
    ...
    <td class="align-middle total-carrito"><b>Total a pagar:</b></td>
    <td class="align-middle">&nbsp;</td>
    <td class="align-middle total-carrito"><b>$${total}</b></td>
